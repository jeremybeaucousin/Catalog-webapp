export class TranslationKeysConstants {
    static readonly ITEMS_PER_PAGE_LABEL: string = "ITEMS_PER_PAGE_LABEL";
    static readonly NEXT_PAGE_LABEL: string = "NEXT_PAGE_LABEL";
    static readonly PREVIOUS_PAGE_LABEL: string = "PREVIOUS_PAGE_LABEL";
    static readonly FIRST_PAGE_LABEL: string = "FIRST_PAGE_LABEL";
