...
@Component({
  selector: 'app-tool-box-table',
  templateUrl: './tool-box-table.component.html',
  styleUrls: ['./tool-box-table.component.sass'],
  animations: [
...
export class ToolBoxTableComponent implements AfterViewInit, OnInit {
